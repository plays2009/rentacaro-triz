<?php
 ...
 <html>
   ...
   <body class="w3-content">
    <form class="w3-center" method=post enctype= "multipart/form-data" action="submitNewProduct.php">

       <h5 class="w3-left" style="margin-left: 10px">차량명 : <input type="text" name="product_name"></input></h5>
     ...
     <table class="w3-table w3-striped w3-bordered" style="width: 100%">
       <tr>
         <td><b>차종</b></td>
         <td><input type="text" name="product_category"></input></td>
       </tr>
      <tr>
        <td><b>차량 가격</b></td>
        <td><input type="text" name="product_price"></input>원</td>
      </tr>
      <tr>
      ...
      <tr>
        <td><b>초기비용 0원</b></td>
        <td style="color: blue"><input type="text" name="first_cost"></input>원</td>
      </tr>
      <tr>
        <td><b>선수금 30%</b></td>
        <td style="color: red"><input type="text" name="pre_pay_30"></input>원</td>
      </tr>
      <tr>
        <td><b>비고</b></td>
        <td><input type="text" name="product_note"></input></td>
      </tr>
     </table>
